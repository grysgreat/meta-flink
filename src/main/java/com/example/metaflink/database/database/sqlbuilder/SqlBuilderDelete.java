 ...
 */
package com.example.metaflink.database.database.sqlbuilder;

import com.example.metaflink.database.database.Database;
...
public class SqlBuilderDelete implements SqlBuilder{
    ...
    public String buildSql(String tableName, String pk, List<String> filedNames, String queryFilter, String quotation, Database database) {
        ...
        return "DELETE FROM " + quotation + tableName + quotation + " WHERE " + quotation + pk + quotation +
                "=?";
    }
}
